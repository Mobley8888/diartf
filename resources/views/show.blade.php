    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                      ...
                      <!---Partie reservées pour gerer la notion de version de l'application et le kit du manielle d'utulisatipon--->
            ...
            <div id="layoutSidenav_content">
               <!--((TROU VIDE POUR METTRE ENSEMBLE DU CONTENU DE SPECIFICIT2 DE CHAQUE PAGE))-->
               <div class="card mb-4">
                 ...
                 <!--((fin du TROU VIDE POUR METTRE ENSEMBLE DU CONTENU DE SPECIFICIT2 DE CHAQUE PAGE))-->
